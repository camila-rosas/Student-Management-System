...
Need to be built:
  - Ensure login reads/stores user
  - Add logout logic
  - Filter option
  - SYNCING (!!!)
  - Ensure courses are added dynamically
  - Calculations with billing
  - Validations rules (prerequisites, too many hours, duplications, etc.)
  - Ensure notifications systems can be updated dynamically via admin
  - Don't forget API please thanks
